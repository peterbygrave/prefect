...
1. Create a new **Docker** hybrid work pool, named `my-work-pool` and using the default configuration.

Next, repeat this steps and create a second work pool named `my-work-pool` in the `staging` workspace.
...
1. Click **Work pools** in the sidebar.
1. Open the actions menu for the `my-work-pool` work pool, and then click **Manage Access**.
